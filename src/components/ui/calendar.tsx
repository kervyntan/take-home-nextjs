/**
 * Modified with
 *  1. https://github.com/shadcn-ui/ui/pull/1680 (Calendar dropdown style)
 */
        ...
        Dropdown: ({ ...props }) => (
          <Select
            ...
            <SelectTrigger
              className={cn(
                buttonVariants({ variant: "ghost" }),
                "h-7 w-full py-2 pl-2 pr-1 font-medium [.is-between_&]:hidden [.is-end_&]:hidden [.is-start.is-end_&]:flex"
              )}>
            ...
            <SelectContent className="scrolling-auto max-h-[var(--radix-popper-available-height);] min-w-[var(--radix-popper-anchor-width)] overflow-y-auto md:max-h-96">
              {props.children &&
